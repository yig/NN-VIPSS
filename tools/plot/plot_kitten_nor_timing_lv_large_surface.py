...
lv_stats_dir0 = "./out/kitten_timing_surface_tracker"
...
lv_keys = [ 'build nn HRBF', 'generate voro', 'NN surface']
...
plt.title("Scalable VIPSS Surface Tracker Timing", fontsize=18)
plt.legend()
...
# Show the plot
# plt.show()
save_path = './out/figure/scalable_vipss_surface_tracker.png'
