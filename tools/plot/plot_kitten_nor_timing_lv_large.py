...
lv_stats_dir0 = "./out/kitten_timing_surface_tracker_soft"
...
plt.title("Scalable VIPSS optimizaiton timing -- soft constraints", fontsize=18)
plt.legend()

# Display grid for better readability
plt.grid(True)

save_path = './out/figure/scalable_vipss_normal_estimation_timing_soft.png'
